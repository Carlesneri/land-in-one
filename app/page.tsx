        ...
        <Container>
          <div className="text-center max-w-3xl mx-auto space-y-8 animate-in fade-in duration-500">
            ...
            <div className="flex justify-center">
              <div className="w-16 h-16 rounded-2xl bg-linear-to-br from-indigo-600 to-blue-600 flex items-center justify-center text-white text-3xl font-bold shadow-lg">
                L
              </div>
            </div>
